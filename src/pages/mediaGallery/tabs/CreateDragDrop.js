  ...
  const selectFileInput = ({ accept, onFiles, files, getFilesFromEvent }) => {
    ...
    return (
      ...
      <div class="upload_area_3 form-group">
        <input type="text" class="form-control" placeholder="Add Media Title"  />
      </div>
  ...
  const Preview = ({ meta, files }) => {
    ...
    return (<>
      ...
      <div className="preview-box">
        <div className="pre-img-upload"><img src={previewUrl} />{" "}</div>
        ...
        <div className="pre-content-upload">
          ...
          <div className="pro-brar-ift">
            ...
            <span className="glyphicon glyphicon-remove" onClick={removeFile(files)}></span> 
              {/* {status !== "done" && (
