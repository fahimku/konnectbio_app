            ...
            <div className="col-md-6">
              <div className="row count-main-box card analytic-box">
                ...
                <div className="col-12 count-box">
                  <h5 className="count-title">Country </h5>
                  <h3 className="count">Pakistan</h3>
                </div>
                <div className="col-12 count-box">
                  <h5 className="count-title">City </h5>
                  <h3 className="count">Karachi</h3>
                </div>
                <div className="col-12 count-box">
                  <h5 className="count-title">State </h5>
                  <h3 className="count">Sindth</h3>
                </div>
                <div className="col-12 count-box">
                  <h5 className="count-title">Zip </h5>
                  <h3 className="count">23232</h3>
                </div>
                <div className="col-12 count-box">
                  <h5 className="count-title">Address </h5>
                  <h3 className="count">adm 123 </h3>
                </div>
                <div className="col-12 count-box">
                  <h5 className="count-title">Funding </h5>
                  <h3 className="count">credit</h3>
                </div>
              </div>
            </div>
            <div className="col-md-4">
