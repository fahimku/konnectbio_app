...
function HashtagsList({ title,hashtags,getHashtags,createHashtag,deleteHash,next}) {
    ...
    const handleDelete = (chipToDelete) => () => {
        Swal.fire({
            ...
            if (result.isConfirmed) {
                deleteHash(chipToDelete.hashtag_id)
                .then((res)=>{
                                ...
                                <div className="brand-section dash_block_profile">
                                    <div className="dash_content_profile">
                                        <form onSubmit={handleAdd}>
                                            <p style={{color:'gray',borderBottom:'1px solid lightgray',paddingBottom:10}}>Note: You can add a maximum of 20 unique hashtags within a 7 day period</p>
                                            <Row>
                                                <Col md={12}>
                                                    <div class="mb-3">
                                                        ...
                                                        <div className='d-flex flex-row'>
                                                            <input
                                                                style={{borderTopRightRadius:0,borderBottomRightRadius:0,width:'85%'}}
                                                            ...
                                                            />
                                                            {
                                                                hashLoading?(
                                                                    <Button
                                                                    style={{borderTopLeftRadius:0,borderBottomLeftRadius:0,width:'15%'}}
                                                                        variant="primary"
                                                                        className="btn-block"
                                                                    >
                                                                        <Loader/>
