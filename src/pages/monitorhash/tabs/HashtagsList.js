...
function HashtagsList({
  ...
  function onSubscribe(val){
    ...
    return subscribeServices(val,priceId,"Hashtag",recurring_payment_type,package_id)
  }
  if (!loading) {
    return (
      <React.Fragment>
...
export default connect(mapStateToProps, {...hashActions,...subActions})(HashtagsList);
