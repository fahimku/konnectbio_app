    ...
    const fbLogin = () => {
        ...
        window.FB.login(
                ...
                if (response.authResponse?.accessToken) {
                    fetch(`https://graph.facebook.com/v12.0/oauth/access_token?  
                        ...
                        .then(json => {
                            ...
                            axios.post('/social/fb/token/user',{
            ...
            },
            {
                ...
                scope: "pages_show_list, instagram_content_publish, pages_read_engagement, instagram_basic, instagram_manage_comments, instagram_manage_messages, instagram_manage_insights"
            }
        );
    }
                        ...
                        <div class="col-md-12">
                                        ...
                                        facebookUserAccessToken ? (
                                            !complete ? (
                                                <SelectPages
                                                    ...
                                                    next={() => {
                                                        setComplete(true)
                                                        axios.post('/social/fb/token/page',{
                                                            fbPage:selectedPage,
                                                            instaId:insta
                                                        }).then(()=>{
                                                            var userInfo=JSON.parse(localStorage.getItem('userInfo'))
                                                        ...
                                                        axios.get(`https://graph.facebook.com/${selectedPage}?fields=access_token&access_token=${facebookUserAccessToken}`)
                                                        .then((res)=>{
                                                            axios.post(`https://graph.facebook.com/v12.0/${selectedPage}/subscribed_apps?subscribed_fields=feed&access_token=${res.data.access_token}`)
                                                        })
                            ...
                            >
                                ...
                                <Modal.Body className="bg-white">
                                    Are you sure you want to disconnect both facebook and instagram accounts?
                                    <span className="strong"></span> This will remove all your content from our platform.
